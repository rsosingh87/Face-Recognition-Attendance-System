...
class Student:
    def __init__(self, root):
        ...
        class_Student_frame.place(x=10,y=220,width=610,height=260)
        ...
        studentName_entry=ttk.Entry(class_Student_frame,textvariable=self.var_std_name,width=18,font=("times new roman",10,"bold"))
        ...
        roll_no_entry=ttk.Entry(class_Student_frame,textvariable=self.var_roll,width=18,font=("times new roman",10,"bold"))
        ...
        dob_entry=ttk.Entry(class_Student_frame,textvariable=self.var_dob,width=18,font=("times new roman",10,"bold"))
        ...
        #Phone no
        phone_label=Label(class_Student_frame,text="Phone:",font=("times new roman",10,"bold"),bg="white")
        phone_label.grid(row=3,column=2,padx=10,pady=5,sticky=W)
        
        phone_entry=ttk.Entry(class_Student_frame,textvariable=self.var_phone,width=18,font=("times new roman",10,"bold"))
        ...
        teacher_entry=ttk.Entry(class_Student_frame,textvariable=self.var_teacher,width=18,font=("times new roman",10,"bold"))
        ...
        btn_frame.place(x=0,y=180,width=610,height=30)
        
        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=18,font=("times now roman",10,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)
        
        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=17,font=("times now roman",10,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)
        
        
        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=18,font=("times now roman",10,"bold"),bg="blue",fg="white")
        ...
        btn_frame1.place(x=0,y=210,width=610,height=30)
        
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=37,font=("times now roman",10,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=1)
        
        update_photo_btn=Button(btn_frame1,text="Update Photo Sample",width=37,font=("times now roman",10,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"E:\Face Recognitio System\collect images\united.jpeg")
        img_right=img_right.resize((600,110),Image.LANCZOS)
        ...
        Search_frame.place(x=10,y=100,width=590,height=60)
        ...
        search_btn=Button(Search_frame,text="Search",width=12,font=("times now roman",10,"bold"),bg="blue",fg="white")
        search_btn.grid(row=0,column=3,padx=4)
        
        showAll_btn=Button(Search_frame,text="ShowAll",width=12,font=("times now roman",10,"bold"),bg="blue",fg="white")
        showAll_btn.grid(row=0,column=4,padx=4)
        #table frame
        table_frame=Frame(Right_frame,bd=2,bg="white",relief=RIDGE)
        table_frame.place(x=10,y=170,width=590,height=280)
        
        scroll_x=ttk.Scrollbar(table_frame,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(table_frame,orient=VERTICAL)
        
        self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","semester","id","name","div","roll","gender","dob","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Delete","Successfully deleted student details",parent=seld.root)
